...
<?php endif; ?>
		...
		<form method="post" class="login">
			<p class="form-row form-row-first">
				...
				<input type="email" class="input-text" name="username" id="username" autofocus="TRUE" placeholder="email@domain.com" />
			</p>
	...
	<div class="col-2">
		...
		<form method="post" class="register"  autocomplete="off">
			...
			<?php endif; ?>
				...
				<input type="email" class="input-text" name="email" id="reg_email" placeholder="email@domain.com" value="<?php if (isset($_POST['email'])) echo esc_attr($_POST['email']); ?>" />
			</p>
